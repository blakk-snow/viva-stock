const sampleData = {
    ...
    products: [
      { id: 1, name: "Summer Dress", description: "Light and airy summer dress", category_id: 1, size: "M", color: "Blue", price: 59.99, quantity: 20, reorder_point: 5, image_url: require("../assets/100.png") },
      { id: 2, name: "Denim Jeans", description: "Classic blue denim jeans", category_id: 2, size: "32", color: "Blue", price: 79.99, quantity: 30, reorder_point: 10, image_url: require("../assets/100.png") },
      { id: 3, name: "Cotton T-Shirt", description: "Basic white cotton t-shirt", category_id: 3, size: "L", color: "White", price: 19.99, quantity: 50, reorder_point: 15, image_url: require("../assets/100.png") },
      { id: 4, name: "Leather Belt", description: "Classic brown leather belt", category_id: 4, size: "One Size", color: "Brown", price: 29.99, quantity: 25, reorder_point: 8, image_url: require("../assets/100.png") },
    ],
    sales: [
