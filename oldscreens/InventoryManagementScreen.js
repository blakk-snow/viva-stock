...
const InventoryManagementScreen = ({ navigation }) => {
  ...
  useEffect(() => {
    setProducts([
      { id: '1', name: 'Bags', inStock: 287, outOfStock: 148, icon: '🥕' },
      { id: '2', name: 'Shoes', inStock: 124, outOfStock: 87, icon: '🍰' },
      { id: '3', name: 'Clothings', inStock: 88, outOfStock: 27, icon: '🍟' },
      { id: '4', name: 'Accessories', inStock: 450, outOfStock: 234, icon: '🍎' },
    ]);
  }, []);
